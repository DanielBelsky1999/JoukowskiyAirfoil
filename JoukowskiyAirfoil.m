...
function UI_Init(C, EPSILON, M, U, Gamma, Transform, VERSION)
    ...
    check_box_PressureMap.Callback = @(es, ed)    Complete_UI_Update(C, slider_eps.Value, slider_M.Value, slider_Gamma.Value, U, Transform, EPSILON_Handle, M_Handle, GAMMA_Handle, SubTitle1_Handle, SubTitle2_Handle, check_box_StreamLines.Value, check_box_Zoom.Value, es.Value, check_box_Fill.Value, axL, axR, axZoom, plot_limits);   
